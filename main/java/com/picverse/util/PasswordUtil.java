 ...
 * It provides methods to generate random nonces, derive AES keys from passwords,
 * and encrypt/decrypt passwords securely.
 */
public class PasswordUtil {
	 ...
	 * The method generates a random salt and IV, derives a secret key from the password,
	 * and returns the encrypted password as a Base64 encoded string.
	 *
	 * @param employee_id The employee ID used to derive the secret key.
     ...
     * The method extracts the IV and salt from the encrypted password,
     * derives the secret key from the employee ID,
