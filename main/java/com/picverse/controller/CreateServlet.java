...
//	    String uploadPath = getServletContext().getRealPath("") + "/src/main/webapp/uploads/images/" + imagefileName;
	    String uploadPath = "C:/Users/dell/eclipse-workspace/Coursework/src/main/webapp/uploads/images/" + imagefileName;
	    ...
	    try {
	        ...
	        String query = "INSERT INTO posts (caption, image) VALUES (?, ?)";
