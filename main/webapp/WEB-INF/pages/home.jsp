			...
			<div class="home-post">
				...
				<div class="home-post-footer">
					<div class="home-actions">
						<div class="home-like-btn" data-post-id="${post.id}">
							<i class="fa-regular fa-heart"></i>
							<p class="likes" id="like-count-${post.id}">${post.likeCount}
								likes</p>
						</div>
						<a href="${pageContext.request.contextPath}/view?id=${post.id}"
			...
			likeBtns.forEach(btn => {
				btn.addEventListener("click", () => {
					...
					.then(data => {
						...
						const likeText = btn.querySelector(".likes");
						...
						// Update like count
						likeText.innerText = data.count + " likes";
					});
				});
			});
		});
