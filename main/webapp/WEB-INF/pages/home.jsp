	...
	<main class="home-main">
		...
		<div class="home-post">
			<div class="home-post-header">
				<img src="${pageContext.request.contextPath}/resources/Images/lion.jpg"
			...
			<div class="home-post-image">
				<a href="${pageContext.request.contextPath}/view"> <img src="${pageContext.request.contextPath}/resources/Images/flower.jpg"
					alt="Post Image" />
				</a>
			</div>
		...
		<div class="home-post">
			<div class="home-post-header">
				<img src="${pageContext.request.contextPath}/resources/Images/lion.jpg" alt="Profile Picture"
			...
			<!-- This is the post image.  -->
			<div class="home-post-image">
				<a href="view.jsp"> <img src="${pageContext.request.contextPath}/resources/Images/lion.jpg"
					alt="Post Image" />
				</a>
			</div>
