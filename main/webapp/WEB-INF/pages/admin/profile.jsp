...
<body>
	...
	<div id="settingsPopup" class="popup">
		<div class="popup-content">
			...
			<h3>Settings</h3>
			<ul>
				<li><a href="#" onclick="openEditProfile()">Edit Profile</a></li>
	...
	<script>
        ...
        function openEditProfile() {
            window.open("${pageContext.request.contextPath}/editPage.jsp", "EditProfile", "width=450,height=600,scrollbars=yes,resizable=no");
            settingsPopup.style.display = "none"; // Close settings popup after opening edit profile
        }

        // Close settings popup when clicking outside
        window.addEventListener('click', (event) => {
            if (!event.target.closest('.popup') && !event.target.closest('#settingsLink')) {
                settingsPopup.style.display = "none";
            }
        });
