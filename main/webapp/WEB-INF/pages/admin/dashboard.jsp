...
<body>
	...
	<div class="dashboard-main">
		...
		<div class="pie-section">
			...
			<!-- >
			<div class="pie-chart">
				<img src="${pageContext.request.contextPath}/resources/Images/pieChart1.jpeg" alt="Pie Chart 1">
        		<img src="${pageContext.request.contextPath}/resources/Images/pieChart2.jpeg" alt="Pie Chart 2">
			</div>
			-->
