...
<body>
	...
	<main class="left-navbar">
		<div class="left-nav-item">
			...
			<!-- Setting option  -->
			<a href="${pageContext.request.contextPath}/contact" class="left-nav-item-common"> <i
			...
			<!-- .Logout  option  -->
			<form class="left-nav-item-common" action="${pageContext.request.contextPath}/logout" method="post">
                <i class="fa-solid fa-right-from-bracket"></i>
