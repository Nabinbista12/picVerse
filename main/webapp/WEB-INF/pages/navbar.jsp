...
<link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@300;400;600&family=Poppins:wght@300;400;500;600&display=swap" rel="stylesheet">
</head>
	...
	<header class="top-navbar">
		...
		<div class="profile-dropdown">
			<div class="profile-trigger">
				<img src="${pageContext.request.contextPath}/resources/Images/lion.jpg" alt="User">
				<span>
					<%
			...
			<div class="dropdown-menu">
				<a href="${pageContext.request.contextPath}/profile"><i class="fa-regular fa-user"></i> Profile</a>
