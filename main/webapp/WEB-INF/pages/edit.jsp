	...
	<main class="edit">
		...
		<form action="#" class="edit-main">
			<div class="edit-post">
				...
				<textarea name="caption" id="" class="edit-caption" rows="10"
					cols="30" placeholder="Enter caption or the detail of the post">I am chaning profile picture after long time. This is of the lion which i found in internet.</textarea>
